...
//                                             Last name
//                                         </Label>
//                                         <Input value={undefined} {...register("lastName", { required: true })} placeholder="Enter your last name" />
...
//                                         Email
//                                     </Label>
//                                     <Input value={undefined} {...register("email", { required: true })} placeholder="Enter your email" type="email" />
